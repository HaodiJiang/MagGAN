...
# def danet_resnet101():
    ...
    # input1 = Input(shape=(256, 256, 1), name='input_1')
    ...
    # input2 = Input(shape=(256, 256, 1), name='input_2')
    ...
    activation = Conv2D(1, 1, padding='same', use_bias=False, name = 'b', kernel_initializer='he_normal')(conv12)
    #activation = Conv2D(1, 1, padding='same', use_bias=False, kernel_initializer='he_normal')(conv12)
...
#
# model = danet_resnet101(height=256, width=256, channel=1)
# model.summary()
